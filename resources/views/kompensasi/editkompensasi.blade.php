...
<div class="card" style="margin:20px;">
    <div class="card-header">Edit Kompensasi</div>
        <div class="card-body">
            <form action="/admin/editkompensasi/{{$kompensasi->id}}" method="POST">
                @method("PUT")
                @csrf
                <input type="hidden" name="id" id="id" value="{{$kompensasi->id}}"/>
                <div class="col-5">
